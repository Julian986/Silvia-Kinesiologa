  ...
  return (
    <footer className="border-t border-slate-200 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4 text-slate-600">
        <div>
          <h3 className="font-semibold text-slate-900">Lic. Silvia González</h3>
        ...
        <div>
          ...
          <ul className="mt-3 grid gap-2">
            ...
            <li className="flex items-start gap-2"><EnvelopeIcon className="w-5 h-5 text-blue-600" /><a href="mailto:consultas@silviagonzalez.com" className="hover:text-blue-600">consultas@silviagonzalez.com</a></li>
      ...
      <div className="border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-slate-500">
          <p>© {new Date().getFullYear()} Lic. Silvia González - Kinesióloga. Todos los derechos reservados.</p>
