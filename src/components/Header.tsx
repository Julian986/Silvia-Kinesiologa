    ...
    <header className="fixed top-0 inset-x-0 z-50 bg-white/80 backdrop-blur border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-16 flex items-center justify-between">
          <a href="#inicio" className="font-semibold text-slate-800 text-lg tracking-tight">Lic. Silvia <span className="text-blue-600">González</span></a>
      ...
      {open && (
        <div className="md:hidden fixed inset-0 z-[9999] bg-white h-dvh min-h-screen overflow-auto animate-fadeIn">
          <div className="h-16 px-4 flex items-center justify-between border-b border-slate-200">
            <a href="#inicio" onClick={() => setOpen(false)} className="font-semibold text-slate-800 text-lg tracking-tight">Lic. Silvia <span className="text-blue-600">González</span></a>
